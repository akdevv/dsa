...
**Target:** 8 problems/day · 474 total · Jun 7 → Aug 7, 2026

Status key: `✅ full` · `⚡ min` · `⏭ skip`
...
- pattern 1–14, 22 (tuf_pattern_1 → tuf_pattern_14, tuf_pattern_22)
  **Notes:** Solved all basic patterns. Key insight from pattern 22: instead of splitting grid into regions, use `n - min(dist to each border)` — one formula covers every cell.
